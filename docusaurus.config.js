...
const config = {
    ...
    [
      ...
      ({
        ...
        /* blog: {
          ...
          // Please change this to your repo.
          // Remove this to remove the "edit this page" links.
          // editUrl: 'https://github.com/Vampurica/vampurica.github.io',
  ...
  themeConfig:
    ...
    ({
      ...
      image: 'img/darkskylines-social-card.jpg',
      navbar: {
        title: 'Dark Skylines',
        logo: {
          alt: '.',
      ...
      footer: {
        ...
        <div style="border-style: dotted; border-color: #c52827;"><a href="https://www.paradoxinteractive.com/games/world-of-darkness/community/dark-pack-agreement" target="_blank" rel="noreferrer noopener" aria-label="Dark Pack Agreement">
            <img src="/img/darkpack_logo2.png" alt="Dark Pack Logo" width="125" height="125" style="float: left;"/>
        </a>
